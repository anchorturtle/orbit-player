...
(function () {
  ...
  function setTitles(title, artist) {
    ...
    if (fpTitle) {
      fpTitle.textContent = (typeof softBreakTitle === 'function')
        ? softBreakTitle(title || 'Custom')
        : (title || 'Custom');
    }
    ...
    if (focalTitle) {
      ...
      } else if (typeof softBreakTitle === 'function') {
        focalTitle.textContent = softBreakTitle(title || 'Custom');
      } else {
